...
business <- read.csv("C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/business_restaurants.csv")
...
review <- read.csv("C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/review_train.csv")
...
write.csv(reviewsCool,"C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/cool_reviews.csv")
write.csv(reviewsUseful,"C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/useful_reviews.csv")
write.csv(reviewsFunny,"C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/funny_reviews.csv")
...
write.csv(d,"C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/LowRatedWords.csv")
write.csv(dd,"C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/HighRatedWords.csv")
# Generate the WordCloud

# Please change the file system path for your workspace
par(bg="yellow")
png(file="C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/WordCloudLow.png",width=1000,height=700, bg="white")
...
# Please change the file system path for your workspace
par(bg="yellow")
png(file="C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/WordCloudHigh.png",width=1000,height=700, bg="white")
...
review <- read.csv("C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/cool_reviews.csv")
...
# Generate the WordCloud
par(bg="yellow")
png(file="C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/WordCloudCool.png",width=1000,height=700, bg="white")
...
write.csv(review, "C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/cool_reviews_with_score.csv")
sum(bin_vector)
mean(bin_vector)
summary(bin_vector)
#--------------
...
review <- read.csv("C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/funny_reviews.csv")
review_textLow <- review$text
reviewSourceLow <- VectorSource(review_textLow)
reviewCorpusLow <- VCorpus(reviewSourceLow)
# Convert the text to lower case
...
# Generate the WordCloud
par(bg="yellow")
png(file="C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/WordCloudFunny.png",width=1000,height=700, bg="white")
wordcloud(d$word, d$freq, min.freq=1,max.freq = 1000,max.words=500, col=terrain.colors(length(d$word),alpha=0.9), random.order=FALSE, rot.per=0.3 )
#title(main = "Highest frequency words in reviews voted cool)", font.main = 1, col.main = "cornsilk3", cex.main = 1.5)
dev.off()
...
bin_vector <- get_sentiment(rText, method="bing")
review$score = bin_vector
write.csv(review, "C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/funny_reviews_with_score.csv")
sum(bin_vector)
mean(bin_vector)
summary(bin_vector)
#--------------
...
review <- read.csv("C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/useful_reviews.csv")
review_textLow <- review$text
reviewSourceLow <- VectorSource(review_textLow)
reviewCorpusLow <- VCorpus(reviewSourceLow)
# Convert the text to lower case
...
# Generate the WordCloud
par(bg="yellow")
png(file="C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/WordCloudUseful.png",width=1000,height=700, bg="white")
wordcloud(d$word, d$freq, min.freq=1,max.freq = 1000,max.words=500, col=terrain.colors(length(d$word),alpha=0.9), random.order=FALSE, rot.per=0.3 )
#title(main = "Highest frequency words in reviews voted cool)", font.main = 1, col.main = "cornsilk3", cex.main = 1.5)
dev.off()
...
bin_vector <- get_sentiment(rText, method="bing")
review$score = bin_vector
write.csv(review, "C:/Users/Jrapose/Documents/DataSci6300/Project/YelpDatasets/useful_reviews_with_score.csv")
sum(bin_vector)
mean(bin_vector)
summary(bin_vector)
